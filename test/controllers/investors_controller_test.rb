...
class InvestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post investors_url, params: { investor: { address: @investor.address, city: @investor.city, first_name: @investor.first_name, investor_id: @investor.investor_id, last_name: @investor.last_name, state: @investor.state, zip: @investor.zip } }
    end
  ...
  test "should update investor" do
    patch investor_url(@investor), params: { investor: { address: @investor.address, city: @investor.city, first_name: @investor.first_name, investor_id: @investor.investor_id, last_name: @investor.last_name, state: @investor.state, zip: @investor.zip } }
